...
La donnée sur les cas est la plus utilisée publiquement mais elle souffre d'une lacune importante: on ne trouve que ce qu'on cherche; les cas augmentent si on teste la population et selon la population que l'on teste. Comme la maladie peut être asymptomatique chez une portion (inconnue) de la population, on ne sait pas combien de cas on rate. Manque-t-on la moitié des cas? 90% des cas? De nombreuses hypothèses circulent. Dans le cas du Québec en particulier, une augmentation significative du nombre de test, ainsi qu'un changement de méthodologie dans la gestion des cas "probables" fait qu'en date du 23 mars on voit apparaitre beaucoup plus de cas. C'est là un artefact méthodologique, pour l'ensemble de mes analystes, je tiens relativement peu compte de l'avant 23 mars. Une information largement manquante dans les graphiques publiés (et je souffre de la même lacune) consiste à regarder le nombre de tests réalisés. L'évolution du ratio tests positifs / négatifs sera sûrement riche d'information aussi.

<div style="margin-left : -100px; height: 640px">
<iframe width="1050" height="600" frameborder="0" scrolling="no" src="//plotly.com/~hoedic/80.embed"></iframe>
</div>
<div class="photoattrib">Données quotidiennes et cumulatives des cas de COVID-19 au Québec</div>


Les données d'hospitalisation sont plus [fiables](https://twitter.com/NateSilver538/status/1242208166202478593) mais sont en retard sur les cas. En effet, alors que des porteurs peuvent être identifiés relativement tôt dans le développement de l'infection, l'hospitalisation va arriver généralement plus tard -quand elle arrive. Les hospitalisations sont importantes pour évaluer l'impact sur le système de santé, toutefois pour envisager l'impact des mesures de mitigation, le retard est problématique. Au moment d'écrire ces lignes, le taux d'hospitalisation au Québec est plus faible qu'à bien d'autres places. Cela peut se traduire par plusieurs éléments, par exemple le Québec teste plus qu'ailleurs et donc le dénominateur du ratio d'hospitalisation (nombre d'hospitalisations / nombre de cas déclarés) est plus élevé. C'est le problème des ratios, ils sont valables si on peut contrôler un des deux facteurs, ce qui n'est pas toujours le cas.


<div style="margin-left : -100px; height: 740px">
<iframe width="1050" height="700" frameborder="0" scrolling="no" src="//plotly.com/~hoedic/82.embed"></iframe>
</div>
<div class="photoattrib">Données quotidiennes et cumulatives des hospitalisations et des décès en lien avec la COVID-19 au Québec</div>
...
<div style="margin-left : -100px; height: 740px">
<iframe width="1050" height="700" frameborder="0" scrolling="no" src="//plotly.com/~hoedic/75.embed"></iframe>
</div>
<div class="photoattrib">Évolution comparée du Québec et d'autres pays du nombre de cas cumulatifs de COVID-19</div>
...
Le gouvernement chinois est sûrement coupable d'avoir caché beaucoup d'information et selon toute vraisemblance d'avoir caché l'ampleur de la situation, mais leur décision d'imposer le bouclage strict d'une province de 50 millions d'habitants relativement tôt (bien des pays occidentaux ont attendu plus longtemps pour décider un bouclage) a sûrement fait [gagner du temps](https://www.statnews.com/2020/02/21/coronavirus-wuhan-quarantine-bought-world-time-to-prepare/) au reste du monde, plusieurs jours voire semaines.
...
<div class="photoattrib">Évolution du cumulatif de cas de COVID-19 en Norvège. Source: <a href="@@PROT6@@>Worldometers</a></div>
...
Si vous voulez voir de manière plus détaillée comment fonctionne une épidémie et l'effet d'un confinement, cet [article](https://medium.com/data-for-science/epidemic-modeling-101-or-why-your-covid19-exponential-fits-are-wrong-97aa50c55f8) est très bien fait.
...
Tel que mentionné plus haut, il est difficile d'éviter cette ultime stratégie considérant la situation. La croissance explosive du nombre de cas et l'inertie entre la prise de mesure et leurs effets a fait qu'il était nécessaire d'agir de manière décisive et rapidement. Même si le confinement est perçu comme une [méthode archaïque](http://jdmichel.blog.tdg.ch/archive/2020/03/18/covid-19-fin-de-partie-305096.html) digne des époques féodales, elle a prouvé son efficacité dans plusieurs régions. Toutefois, comme je l'expliquerai dans le prochain billet, nous ne pouvons nous en tenir à ça: hormis un endiguement réussi, toutes les stratégies qui nous permettent de ressortir rapidement d'un volume significatif laisse le virus en circulation et la population susceptible, à risque d'être infectée.
